...
To significantly reduce Botium Toys’ risk exposure and ensure business continuity, immediate action is required to implement a defense-in-depth strategy. The priority is to establish strong administrative controls, specifically Least Privilege and Separation of Duties, to limit internal access. Simultaneously, technical defenses must be bolstered by deploying an Intrusion Detection System (IDS), implementing encryption for data at rest and in transit, and formalizing legacy system management. Finally, to meet compliance standards (such as PCI DSS and GDPR), the organization must enforce robust password policies and conduct a thorough asset classification to ensure sensitive data is identified and protected accordingly.
